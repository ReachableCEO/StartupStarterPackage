...
- [Busiess Model Canvas](./BusinessModelCanvas/BusinessModelCanvas.md)
- [Channels](./BusinessModelCanvas/Channels.md)
- [Customer Relationships](./BusinessModelCanvas/Customer_Relationships.md)
- [Customer Segments](./BusinessModelCanvas/Customer_Segments.md)
- [Financial Plan](./BusinessModelCanvas/Financial_Plan.md)
- [Key Activities](./BusinessModelCanvas/Key_Activities.md)
- [Key Partners](./BusinessModelCanvas/Key_Partners.md)
- [Key Resources](./BusinessModelCanvas/Key_Resources.md)
- [Team Leaders](./BusinessModelCanvas/team-leaders.md)
- [Value Propositions](./BusinessModelCanvas/Value_Propositions.md)
...
- [Objective](./StrategicContext/Objective.md)
- [Current State Of Play](./StrategicContext/CurrentStateOfPlay.md)
- [Difference](./StrategicContext/Difference.md)
- [Market](./StrategicContext/Market.md)
- [Victory Conditions](./StrategicContext/VictoryConditions.md)
- [Cost](./StrategicContext/Cost.md)
- [Entrance/Exit Criteria](./StrategicContext/EntranceExitCriteria.md)
- [SWOT](./StrategicContext/SWOT.md)
- [Timeline](./StrategicContext/Timeline.md)
